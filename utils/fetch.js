...
function ljgkfetch(api, path, params) {
...
function ljgkfetchpost(api, path, params) {
  return new Promise((resolve, reject) => {
    wx.request({
      url: `${api}?action=${path}`,
      data: Object.assign({}, params),
...
function ljgkfetch1(api, path, params, info, loadingShow, loadingMsg) {
  return new Promise((resolve, reject) => {
...
module.exports = { ljgkfetch, ljgkfetchpost,ljgkfetch1}